...
Three experiments were conducted by varying the learning rate and activation function to observe their impact on model performance. Each experiment was run for 5 epochs.
...
|----------------------|-----------|---------------|----------|------------|---------------|
| Baseline             | 0.0804    | 97.57%        | 0.0037   | relu       | 0.001         |
| High_LR              | 0.2226    | 95.48%        | 0.0071   | relu       | 0.01          |
| Sigmoid_Activation   | 0.1028    | 97.00%        | 0.0047   | sigmoid    | 0.001         |
